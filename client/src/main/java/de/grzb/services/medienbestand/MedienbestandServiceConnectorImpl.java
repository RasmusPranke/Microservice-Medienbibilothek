 ...
 * @version SoSe 2014
 */
public class MedienbestandServiceConnectorImpl extends AbstractObservableService
        implements MedienbestandServiceConnector
{
     ...
     * @require medien != null
     */
    public MedienbestandServiceConnectorImpl(List<Medium> medien)
    {
