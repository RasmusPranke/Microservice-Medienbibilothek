package de.grzb.werkzeuge.ausleihe;
...
import de.grzb.services.ServiceObserver;
...
import de.grzb.services.verleih.ProtokollierException;
import de.grzb.services.verleih.VerleihServiceConnector;
import de.grzb.werkzeuge.SubWerkzeugObserver;
import de.grzb.werkzeuge.subwerkzeuge.ausleihemedienauflister.AusleiheMedienauflisterWerkzeug;
import de.grzb.werkzeuge.subwerkzeuge.kundenauflister.KundenauflisterWerkzeug;
import de.grzb.werkzeuge.subwerkzeuge.kundendetailanzeiger.KundenDetailAnzeigerWerkzeug;
import de.grzb.werkzeuge.subwerkzeuge.mediendetailanzeiger.MedienDetailAnzeigerWerkzeug;
...
public class AusleihWerkzeug
{
     ...
     */
    private final VerleihServiceConnector _verleihService;
     ...
     * @param verleihServiceConnector Der Verleih-Service.
     * 
     * @require medienbestand != null
     * @require kundenstamm != null
     * @require verleihService != null
     */
    public AusleihWerkzeug(MedienbestandServiceConnector medienbestand,
            KundenstammServiceConnector kundenstamm, VerleihServiceConnector verleihServiceConnector)
    {
        assert medienbestand != null : "Vorbedingung verletzt: medienbestand != null";
        assert kundenstamm != null : "Vorbedingung verletzt: kundenstamm != null";
        assert verleihServiceConnector != null : "Vorbedingung verletzt: verleihService != null";

        _verleihService = verleihServiceConnector;
        ...
        _medienAuflisterWerkzeug = new AusleiheMedienauflisterWerkzeug(
                medienbestand, verleihServiceConnector);
